...
# Title: Top Block
# Generated: Fri Nov  1 23:03:41 2019
##################################################
...
class top_block(gr.top_block):
    ...
    def __init__(self, b=5e6, base_port="6700", f="/home/datqm/Desktop/Share_Folder/Share_Folder/test_613.cfile", fc=[1856.4e6,1856.4e6+5e6,1856.4e6 + 10e6,1856.4e6-10e6,1856.4-5e6], fn=0, hsn=21, id_start=1, ma=[726,806,808,811], maio=2, n="offsetCFile", nstream=5, osr=4, s=3.25e6, s1=25e6/9, sample_start=30099, tseq=2, tslot=1):
        ...
        self.uhd_usrp_source_0.set_center_freq(1856.4e6, 0)
        ...
        self.gsm_insert_db_0 = grgsm.insert_db()
        self.gsm_file_sink_6 = grgsm.file_sink(gr.sizeof_gr_complex*1, "/media/datqm/sdb2/downlink/file_01/", "1856400000", samp_rate/5, "Down", False)
        self.gsm_file_sink_5 = grgsm.file_sink(gr.sizeof_gr_complex*1, "/media/datqm/sdb2/downlink/file_03/", "1864400000", samp_rate/5, "Down", False)
        self.gsm_file_sink_4 = grgsm.file_sink(gr.sizeof_gr_complex*1, "/media/datqm/sdb2/downlink/file_04/", "1848400000", samp_rate/5, "Down", False)
        self.gsm_file_sink_3 = grgsm.file_sink(gr.sizeof_gr_complex*1, "/data/uplink/file_01/", "1856400000", samp_rate/5, "Up", False)
        self.gsm_file_sink_2 = grgsm.file_sink(gr.sizeof_gr_complex*1, "/media/datqm/sdb2/downlink/file_02/", "1860400000", samp_rate/5, "Down", False)
        self.gsm_file_sink_1_0_0_0 = grgsm.file_sink(gr.sizeof_gr_complex*1, "/data/uplink/file_05/", "1852400000", samp_rate/5, "Up", False)
        self.gsm_file_sink_1_0_0 = grgsm.file_sink(gr.sizeof_gr_complex*1, "/data/uplink/file_04/", "1848400000", samp_rate/5, "Up", False)
        self.gsm_file_sink_1_0 = grgsm.file_sink(gr.sizeof_gr_complex*1, "/data/uplink/file_03/", "1864400000", samp_rate/5, "Up", False)
        self.gsm_file_sink_1 = grgsm.file_sink(gr.sizeof_gr_complex*1, "/data/uplink/file_02/", "1860400000", samp_rate/5, "Up", False)
        self.gsm_file_sink_0 = grgsm.file_sink(gr.sizeof_gr_complex*1, "/media/datqm/sdb2/downlink/file_05/", "1852400000", samp_rate/5, "Down", False)
        ...
        # Connections
        ##################################################
        self.msg_connect((self.gsm_file_sink_0, 'msg_out'), (self.gsm_insert_db_0, 'msg_in'))    
        self.msg_connect((self.gsm_file_sink_1, 'msg_out'), (self.gsm_insert_db_0, 'msg_in'))    
        self.msg_connect((self.gsm_file_sink_1_0, 'msg_out'), (self.gsm_insert_db_0, 'msg_in'))    
        self.msg_connect((self.gsm_file_sink_1_0_0, 'msg_out'), (self.gsm_insert_db_0, 'msg_in'))    
        self.msg_connect((self.gsm_file_sink_1_0_0_0, 'msg_out'), (self.gsm_insert_db_0, 'msg_in'))    
        self.msg_connect((self.gsm_file_sink_2, 'msg_out'), (self.gsm_insert_db_0, 'msg_in'))    
        self.msg_connect((self.gsm_file_sink_3, 'msg_out'), (self.gsm_insert_db_0, 'msg_in'))    
        self.msg_connect((self.gsm_file_sink_4, 'msg_out'), (self.gsm_insert_db_0, 'msg_in'))    
        self.msg_connect((self.gsm_file_sink_5, 'msg_out'), (self.gsm_insert_db_0, 'msg_in'))    
        self.msg_connect((self.gsm_file_sink_6, 'msg_out'), (self.gsm_insert_db_0, 'msg_in'))    
